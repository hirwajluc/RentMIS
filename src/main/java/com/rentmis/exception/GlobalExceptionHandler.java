...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RentMISException.class)
    public ResponseEntity<ApiResponse<Void>> handleRentMISException(RentMISException ex) {
        log.warn("RentMIS error [{}]: {}", ex.getStatus(), ex.getMessage());
